...
namespace GodSpeedGames.Tools
{
    ...
    public class GSGSimpleObjectPooler : GSGObjectPooler
    {
        [Tooltip("The game object we'll instantiate ")]
        public GameObject GameObjectToPool;
        [Tooltip("The number of objects we'll add to the pool")]
        public int PoolSize = 20;
        [Tooltip("If true, the pool will automatically add objects to the itself if needed")]
