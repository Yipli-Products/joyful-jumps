...
namespace GodSpeedGames.Tools
{
    ...
    /// </summary>
    public class GSGObjectPooler : MonoBehaviour
    {
        public static GSGObjectPooler Instance;
        ...
        [Tooltip("If this is true, all waiting and active objects will be regrouped under an empty game object. Otherwise they'll just be at top level in the hierarchy")]
        ...
        {
            if (_event == GSGGameEvent.PlayerRespawn || _event == GSGGameEvent.LevelStart)
            {
