...
public class GameOverScreen : MonoBehaviour
{
    ...
    public void SetData()
    {
        ...
        float calories = YipliUtils.GetCaloriesBurned(PlayerSession.Instance.getPlayerActionCounts());
        float fitnessPoints = YipliUtils.GetFitnessPoints(PlayerSession.Instance.getPlayerActionCounts());
